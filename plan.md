...
- **Функциональные требования**:
  - Определить, какие категории событий (из 1–21, описанных в `api.html`) входят в **MVP** сенсор-агента.
  - Зафиксировать требования по **SLA доставки** событий: допустимая задержка, допустимая потеря при перегрузке.
